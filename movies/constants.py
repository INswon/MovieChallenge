...
RECOMMEND_MOVIE = {
    ...
    "scary": [
        {
            "title": "羊たちの沈黙",
            "note": "心理戦と異常犯罪の緊迫感。静かな恐怖が背筋を凍らせる",
            "poster": "",
            "year": 1991,
        },
        {
            "title": "ザ・メニュー",
            "note": "美食の場で展開する狂気のサスペンス。予測不能の展開に不安が募る",
            "poster": "",
            "year": 2022,
        },
        {
            "title": "エクソシスト",
            "note": "悪魔に憑かれた少女を巡る衝撃の恐怖体験。ホラー映画の金字塔",
            "poster": "",
            "year": 1973,
        }
    ],
    "curious": [
        {
            "title": "インセプション",
            "note": "夢の中の夢を舞台にした頭脳ゲーム。複雑で新鮮な設定に引き込まれる",
            "poster": "",
            "year": 2010,
        },
        {
            "title": "インターステラー",
            "note": "科学と愛をテーマにした壮大な宇宙探査。知的好奇心を刺激する傑作",
            "poster": "",
            "year": 2014,
        },
        {
            "title": "メメント",
            "note": "記憶を失う主人公の物語が逆再生される構成。意外性と深い考察を誘う",
            "poster": "",
            "year": 2000,
        }
    ]
